...
def main_menu() -> str:
    ...
    menu_lines = [
        ...
        entry("delete [name]", "Remove a contact and all their data."),
        entry("add-birthday [name] [DD.MM.YYYY]", "Attach a birthday to an existing contact."),
        entry("delete-birthday [name]", "Remove a saved birthday."),
        ...
        entry("delete-phone [name] [phone_number]", "Remove a specific phone number from a contact."),
...
COMMAND_HANDLERS = {
    ...
    'delete': partial(handle_delete, address_book=ADDRESS_BOOK),
    'add-birthday': partial(handle_add_birthday, address_book=ADDRESS_BOOK),
    'delete-birthday': partial(handle_delete_birthday, address_book=ADDRESS_BOOK),
    ...
    'delete-phone': partial(handle_delete_phone, address_book=ADDRESS_BOOK),
